...
class DataIngestionConfig:
    def __init__(self):
        ...
        self.raw_data_path = os.path.join(project_root, "Artifacts", "Raw_data.csv")
        self.train_data_path = os.path.join(project_root, "Artifacts", "Train_data.csv")
        self.test_data_path = os.path.join(project_root, "Artifacts", "Test_data.csv")
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            # Use absolute paths
            project_root = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../..'))
            data_path = os.path.join(project_root, "Notebook_Experiments", "Data", "data.csv")
